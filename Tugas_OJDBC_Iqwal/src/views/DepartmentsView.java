...
public class DepartmentsView extends javax.swing.JInternalFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String message = this.controller.addDepartment(dept_id, dept_name, manager_id, loc_id);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        String manager_id = txtManager_ID.getText();
        String loc_id = txtLocation_ID.getText();
        String message = this.controller.editDepartment(dept_id, dept_name, manager_id, loc_id);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String dept_id = txtDepartment_ID.getText();
        if (confirm == 0) {
            String message = this.controller.deleteDepartment(dept_id);
            JOptionPane.showMessageDialog(this, message);
            }
        loadData(controller.getDataDepartements());
